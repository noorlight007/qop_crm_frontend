...
import {
  ...
  useGetNetworkAdviserReportsViewQuery,
} from "@/Redux/Reducers/Network/Adviser/Reports/NetworkAdviserReportsApi";
                    ...
                    <Col>
                      <Card className="shadow-sm border-0">
                        ...
                        <CardBody>
                          {isViewLoading || isFetching ? (
                          ...
                          ) : getNetworkAdviserReportsViewData &&
                            getNetworkAdviserReportsViewData.length > 0 ? (
                            <div className="table-responsive">
                              <table className="table table-hover align-middle">
                                ...
                                <tbody>
                                  {getNetworkAdviserReportsViewData.map(
