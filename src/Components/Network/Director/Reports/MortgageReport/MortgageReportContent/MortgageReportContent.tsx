...
const MortgageReportContent: React.FC = () => {
                  ...
                  <Col md={6} lg={3} className="mb-3">
                    <FormGroup>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          handleFilterChange("report_category", e.target.value)
                        }
                        className="form-select"
                      >
                            ...
                            <table className="table table-hover align-middle">
                              <thead className="table-light">
                                <tr>
                                  ...
                                  <th className="fw-bold">Application Type</th>
...
export default MortgageReportContent;
