...
const DeleteOrgApplicantModal: React.FC<DeleteOrgApplicantModalProps> = ({
  ...
  const [deleteOrgApplicant, { isLoading: isDeletingApplicant }] =
  ...
  const getErrorMessage = (error: any) => {
    ...
    return "Failed to delete applicant. Please try again.";
  };
  ...
  return (
    <Modal isOpen={isOpen} toggle={toggle}>
      <ModalHeader toggle={toggle}>Delete Applicant</ModalHeader>
      <ModalBody>
      ...
      <ModalFooter>
        ...
        >
          {isDeletingApplicant ? "Deleting..." : "Delete"}
        </Button>
      </ModalFooter>
    </Modal>
  );
