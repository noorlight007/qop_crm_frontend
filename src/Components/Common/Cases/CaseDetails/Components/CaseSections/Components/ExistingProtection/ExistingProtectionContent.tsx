                ...
                <CardBody>
                  <div className="px-3">
                    <Label className="mb-3">
                      ...
                      (such as income security, life assurance etc.)
                    </Label>
                          ...
                          {formValues?.will_this_policy_be_cancelled && (
                            <FormGroup>
                              ...
                              <Input
                                ...
                                value={
                                  formValues?.reason_for_policy_cancellation
                                }
                                onChange={(e) =>
                                  handleInputChange(
                          ...
                          <Col md={12}>
                            <FormGroup>
                              ...
                              <Input
                                ...
                                value={
                                  formValues?.policy_cancellation_notes || ""
                                }
                                onChange={(e) =>
                                  handleInputChange(
                        ...
                        <Col md={12}>
                          <FormGroup>
                            ...
                            <Input
                              ...
                              value={
                                formValues?.why_did_you_take_out_this_policy
                              }
                              onChange={(e) =>
                                handleInputChange(
