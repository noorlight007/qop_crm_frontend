              ...
              <TabPane tabId={String(index)} key={policy.alias}>
                ...
                >
                  <Row>
                    <Col sm={12} md={6} lg={4}>
                      <FormGroup>
                        ...
                        >
                          ...
                          <option value="LIFE_DECREASING">
                            Life Decreasing
                          </option>
                          <option value="LIFE_INCREASING">
                            Life Increasing
                          </option>
                    ...
                    {policy.policy_type ===
                      "ACCIDENT_SICKNESS_UNEMPLOYMENT" && (
                      <>
                        <Col sm={12} md={6} lg={4}>
                          <FormGroup>
                    ...
                    {policy.policy_type === "INCOME_PROTECTION" && (
                      <>
                        ...
                        <Col sm={12} md={6} lg={4}>
                          <FormGroup>
                            <Label>
                              Monthly Sum Assured({getCurrencySign()})
                            </Label>
                            <Input
                              type="number"
                              step="0.01"
                        ...
                        >
                          <FormGroup check>
                            <Input
                              ...
                              className="border-primary"
                              checked={
                                policy.buildings_insured_accidental_damage ??
                                false
                              }
                              onChange={(e) =>
                                handleChange(
                            ...
                            />
                            <Label check>
                              Is it important to you that your buildings are
                        ...
                        >
                          <FormGroup check>
                            <Input
                              ...
                              className="border-primary"
                              checked={
                                policy.contents_insured_accidental_damage ??
                                false
                              }
                              onChange={(e) =>
                                handleChange(
                            ...
                            />
                            <Label check>
                              Is it important to you that your contents are
                              insured against accidental damage?
                            </Label>
                          </FormGroup>
                        </Col>
                        ...
                        >
                          <FormGroup check>
                            <Input
                              ...
                              className="border-primary"
                              checked={
                                policy.high_value_items_over_1500 ?? false
                              }
                              onChange={(e) =>
                                handleChange(
                                  index,
                            ...
                            />
                            <Label check>
                              Do you have any specific item of contents worth
                              more than {getCurrencySign()}1500 to replace?
                            </Label>
                          </FormGroup>
                        </Col>
                      </>
                            ...
                            <Col sm={12} md={6} lg={4}>
                              <FormGroup>
                                ...
                                <Input
                                  ...
                                  value={
                                    policy.budget_plan_benefit_period ?? ""
                                  }
                                  onChange={(e) =>
                                    handleChange(
                                      index,
                    ...
                    {(policy.policy_type === "LIFE_LEVEL" ||
                      ...
                      policy.policy_type ===
                        "LIFE_AND_CRITICAL_ILLNESS_LEVEL" ||
                      policy.policy_type ===
                    ...
                    >
                      <FormGroup check>
                        <Input
                          ...
                          className="border-primary"
                          checked={
                            policy.client_accepted_recommendation ?? false
                          }
                          onChange={(e) =>
                            handleChange(
                              index,
                    ...
                    >
                      <FormGroup check>
                        ...
                        />
                        <Label check>
                          Have non-standard terms been issued?
                        </Label>
                      </FormGroup>
                    </Col>
