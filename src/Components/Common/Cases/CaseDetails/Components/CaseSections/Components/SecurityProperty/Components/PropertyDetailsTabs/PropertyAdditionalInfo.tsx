                    ...
                    <Col sm={3} className="d-flex gap-3">
                      ...
                      <div className="form-check">
                        <Input
                          ...
                          value="false"
                          checked={
                            propertyState.is_the_property_a_new_build === false
                          }
                          onChange={handleChange}
                          className="form-check-input"
                        />
                  ...
                  <Col sm={6}>
                    <FormGroup>
                      ...
                      {propertyState.api_errors
                        ...
                        <div className="text-danger">
                          {propertyState.api_errors.new_build_warranty_provider}
                        </div>
                      )}
                    </FormGroup>
                  </Col>
                ...
                <Col sm={12}>
                  <FormGroup>
                    ...
                    <Input
                      ...
                      value={propertyState.please_provide_further_details || ""}
                      onChange={handleChange}
                    />
                    {propertyState.api_errors
                    ...
                    <Col sm={3} className="d-flex gap-3">
                      <div className="form-check">
                        <Input
                          ...
                          value="true"
                          checked={
                            propertyState.is_the_property_on_the_market === true
                          }
                          onChange={handleChange}
                          className="form-check-input"
                        />
