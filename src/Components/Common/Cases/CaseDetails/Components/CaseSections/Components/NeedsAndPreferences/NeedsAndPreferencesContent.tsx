              ...
              >
                <FormGroup>
                  ...
                  <small className="text-muted">
                    ...
                    & part Mortgage provided and ask sufficient questions to
                    recommend an appropriate repayment vehicle (e.g. Pension/
                    ISA, sale of property/ other)
                  </small>
                </FormGroup>
                ...
                <FormGroup>
                  ...
                  <small className="text-muted">
                    ...
                    rate types and what effect they could have for the client.
                    E.g Fixed rate, variable, discount, tracker.
                  </small>
                </FormGroup>

                <FormGroup>
                  <Label>
                    How long do you feel is reasonable to be tied into a
                    specific mortgage deal? (initial benefit period - e.g 2/3/5
                    year fixed) + confirm why.
                  </Label>
                  <Input
                    type="textarea"
                    rows={4}
                  ...
                  <small className="text-muted">
                    Note: Establishes the most appropriate length of deal period
                    for client based on their personal circumstances and
                    establish how long a period of early repayment charges the
                    client is prepared to accept and which is appropriate to
                    their circumstances. are they open to looking at a range of
                ...
                <FormGroup>
                  ...
                  <small className="text-muted">
                    ...
                    term will incur further interest and be more expensive. If
                    there is disposable income for a shorter term, why has this
                    not been recommended. if BTL – do not link term to
                    affordability.
                  </small>
                </FormGroup>
                ...
                <FormGroup>
                  ...
                  <small className="text-muted">
                    Note: Is it important the term finishes before state
                    retirement age or selected retirement age? If chosen
                    retirement age is over state retirement age, confirm
                    plausibility of client working to that age. If Client aged
                    over 55 and mortgage term will exceed state retirement age
                    (or earlier if selected) by more than 2 years – explanation
                    of Later Life lending is provided and pension provisions
                    discussed
                  </small>
                </FormGroup>
                ...
                <FormGroup className="border-primary rounded-2 p-2">
                  ...
                  <Row>
                    <Col md={4}>
                      <FormGroup className="mb-3">
                        <Label className="d-block">
                          No up-front costs (Free Legals, Free Lender Fees and
                          Free Valuation)
                        </Label>
                        <div className="d-flex gap-4">
                          {yesNoOptions.map((option) => (
                            <FormGroup
                              key={`front_costs-${option}`}
                              check
                              inline
                            >
                              <Input
                    ...
                    <Col md={4}>
                      <FormGroup className="mb-3">
                        <Label className="d-block">
                          Early Repayment charges (on partial repayments, No
                          ERCs, no overhang)
                        </Label>
                        <div className="d-flex gap-4">
                          {yesNoOptions.map((option) => (
                  ...
                  <Row>
                    <Col md={4}>
                      <FormGroup className="mb-3">
                        <Label className="d-block">
                          To minimise any lender arrangement costs(No booking
                          fees and no arrangement fees)
                        </Label>
                        <div className="d-flex gap-4">
                          {yesNoOptions.map((option) => (
                            <FormGroup
                    ...
                    <Col md={4}>
                      <FormGroup className="mb-3">
                        <Label className="d-block">
                          The ability to add fees to the mortgage - Client is
                          aware that extra interest will be payable
                        </Label>
                        <div className="d-flex gap-4">
                          {yesNoOptions.map((option) => (
                            <FormGroup
                        ...
                        <div className="d-flex gap-4">
                          {yesNoOptions.map((option) => (
                            ...
                            >
                              ...
                              <Label
                                check
                                for={`speed_of_completion-${option}`}
                              >
                                {option.charAt(0).toUpperCase() +
                                  option.slice(1)}
                              </Label>
                ...
                <FormGroup>
                  <Label>
                    ...
                    reasons; and what impact do you expect the consolidation to
                    have on your lifestyle?
                  </Label>
                  <Input
                    type="textarea"
                    rows={4}
                  ...
                  <small className="text-muted">
                    Note: If you have previously consolidated, please explain
                    why you are re-consolidating and will this reoccur again in
                    the future?
                  </small>
                </FormGroup>
                <FormGroup>
                  <Label>
                    Do you anticipate any changes to your income or expenditure
                    in the near future?
                  </Label>
                ...
                <FormGroup className="border-primary rounded-2 p-2">
                        ...
                        <div className="d-flex gap-4">
                          {yesNoOptions.map((option) => (
                            ...
                            >
                              ...
                              <Label
                                check
                                for={`home_emergency_cover-${option}`}
                              >
                                {option.charAt(0).toUpperCase() +
                                  option.slice(1)}
                              </Label>
                  ...
                  <Row>
                    <Col md={12}>
                      <FormGroup className="mb-2">
                        <Label className="d-block">
                          If Personal possessions, confirm items and amount of
                          cover
                        </Label>
                        <div className="d-flex gap-4">
                          {yesNoOptions.map((option) => (
                ...
                <FormGroup>
                  ...
                  <small className="text-muted">
                    Note: when was it last reviewed? Would you like us to refer
                    you to someone who can draft and update your will?
                  </small>
                </FormGroup>
                <FormGroup>
                  <Label>
                    Is there anything else you would like to discuss or add to
