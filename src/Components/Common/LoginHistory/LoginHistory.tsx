        ...
        <CardBody className='p-4'>
          <div className='d-flex align-items-center mb-4'>
            <div className='bg-light-primary bg-opacity-10 p-3 rounded-3 me-3 position-relative'>
              ...
              ></i>
              <small
                className='position-absolute top-0 end-1 translate-middle bg-primary text-white rounded-circle px-1 text-center'
                style={{ fontSize: '0.7rem', width: '25px', height: '25px' }}
              >
        ...
        <div className='d-flex align-items-center justify-content-between mb-4 pb-3 border-bottom'>
          <div className='d-flex align-items-center'>
            <div className='bg-light-primary bg-opacity-10 p-3 rounded-3 me-3 position-relative'>
              ...
              ></i>
              <small
                className='position-absolute top-0 end-1 translate-middle bg-primary text-white rounded-circle '
                style={{ width: '25px', height: '25px', fontSize: '0.6rem' }}
              >
                <span
