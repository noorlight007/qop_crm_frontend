...
const UpdateNetworkDirectorInfoModal: React.FC<UpdateNetworkInfoModalProps> = ({
  isOpen,
  toggle,
  networkData,
  slug,
    ...
    <Modal isOpen={isOpen} toggle={toggle} centered size="lg">
      <Form onSubmit={handleSubmit}>
        <ModalHeader toggle={toggle}>
          <h2 className="text-primary">Update Network Director Info</h2>
        </ModalHeader>
        <ModalBody>
          <Row>
            <Col sm="6">
...
export default UpdateNetworkDirectorInfoModal;
