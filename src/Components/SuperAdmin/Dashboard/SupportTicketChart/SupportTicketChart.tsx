...
const SupportTicketChart: React.FC = () => {
  ...
  const sample = {
    ...
    inProgress: [10, 12, 11, 14, 15, 13, 16, 18, 17, 15, 14, 12],
    completed: [8, 10, 9, 12, 14, 13, 16, 18, 17, 15, 14, 12],
    resolved: [26, 24, 28, 30, 33, 31, 35, 38, 36, 34, 32, 29],
    closed: [14, 16, 15, 18, 20, 19, 22, 24, 23, 21, 19, 17],
  };
