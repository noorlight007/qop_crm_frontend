...
const AddNetworkCaseModal: React.FC<AddNetworkNewCaseModalProps> = ({
  isOpen,
  toggle,
  applicantId,
  applicantName,
  ...
  const handleCaseCreated = (caseAlias: string) => {
    ...
    router.push(
      getOrganisationCaseUrl(networkslug as string, caseAlias, userRole),
    );
  };
...
export default AddNetworkCaseModal;
