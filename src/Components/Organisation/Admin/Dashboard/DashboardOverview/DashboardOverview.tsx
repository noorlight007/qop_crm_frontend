...
const DashboardOverview: React.FC<AdminDashboardProps> = ({
  isLoading,
  dashboardData,
}) => {
  return (
              ...
              <div>
                ...
                {isLoading ? (
                  ...
                  <h4 className="mb-1 text-dark">
                    {dashboardData?.new_clients_this_month || 0}
                  </h4>
                )}
              </div>
              <div>
            ...
            <div className="d-flex justify-content-between">
              <div>
                ...
                {isLoading ? (
                  ...
                  <h4 className="mb-1 text-dark">
                    {dashboardData?.completed_cases || 0}
                  </h4>
                )}
              </div>
              <div>
            ...
            <div className="d-flex justify-content-between">
              <div>
                ...
                {isLoading ? (
                  ...
                  <h4 className="mb-1 text-dark">
                    {dashboardData?.upcoming_tasks || 0}
                  </h4>
                )}
              </div>
              <div>
