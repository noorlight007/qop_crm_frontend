...
const OrganisationDirectorApplicantsContainer: React.FC = () => {
  return (
    <>
      <Breadcrumbs
        title="Applicant Overview"
        subTitle="Here you can see all the applicants of the organisation"
...
export default OrganisationDirectorApplicantsContainer;
