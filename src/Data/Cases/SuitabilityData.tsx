...
export const protectionOptionTemplates: {
...
}[] = [
  {
    ...
    label: "I recommend you seek advice from a specialist protection advisor.",
...
export const pensionOptions: { value: string; label: string }[] = [
  {
    value: "PENSION_STATEMENTS_REQUIRED",
    label: "Option 1 – Pension statements required by lender",
  },
  {
    value: "PENSION_STATEMENTS_NOT_REQUIRED",
    label: "Option 2 – Pension statements not required by lender",
  },
];

export const notRecommendedOptions: { value: string; label: string }[] = [
  {
    value: "HIGHER_INTEREST_RATE",
    label:
      "the interest rates currently available were higher than the rate on your existing mortgage product.",
  },
  {
    value: "ERC_GREATER_THAN_SAVINGS",
    label:
